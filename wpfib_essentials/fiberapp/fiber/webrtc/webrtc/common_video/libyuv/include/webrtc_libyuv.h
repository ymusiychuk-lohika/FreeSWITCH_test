...
// Copies the raw RGB frame and rotates if required
// Return value: 0 if OK, < 0 otherwise.
int RotateRGBFrameIfNeeded(const uint8_t* src_frame, RGBVideoFrame* dst_frame,
						   int width, int height, VideoRotationMode rotation);

// Copies the I420 data to another I420 frame
int CopyI420(const I420VideoFrame* src_frame,I420VideoFrame* dst_frame);
}
