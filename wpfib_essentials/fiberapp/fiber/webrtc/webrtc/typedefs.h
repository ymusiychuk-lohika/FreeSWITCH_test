...
#define WEBRTC_ARCH_LITTLE_ENDIAN
#define WEBRTC_LITTLE_ENDIAN
#elif defined(__ARMEL__)  && (!defined(WEBRTC_IOS))
...
#define WEBRTC_ARCH_LITTLE_ENDIAN
#define WEBRTC_LITTLE_ENDIAN
#elif defined(WEBRTC_IOS) && (defined(__arm64__) || defined(__ARMEL__))
// Currently the files used from webrtc modules for resolving dependencies
// wrt reference couting implementation doesnt use any of these architecture
// specific #defines
#else
