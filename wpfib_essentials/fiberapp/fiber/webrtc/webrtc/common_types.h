...
enum EcModes                   // type of Echo Control
{
    ...
    kEcAecm,                   // AEC mobile
    kEcBjn,                    // BJN Echo Noise control
    kMaxEcType,                // must be last entry for EcModes dimention
};
...
enum EcDelayModes
{
    kEcReportedLatency,
    kEcStaticLatency,
    kEcAlgorithmicLatency,
};

enum EsModes
{
    kEsMonitor = 0, // no loss only VAD
    kEsAutomatic,
    kEsEnabled,
    kEsNumModes,
};
