...
protected:
    ...
    HRESULT AddToROT();
    void RemoveFromROT();
    int FilterNameFromRegistry(REFCLSID clsid, WCHAR *szName, size_t len);
    void LogPinInfo(IBaseFilter *pFilter);
    void LogFilterInfo(IBaseFilter *pFilter, int nCount);
    void LogFilters();
#endif
...
#ifdef BJN_WEBRTC_CHANGES
    BJN::ScreenCapturer* _screenCapturer;
    DWORD _rotRegistration;
#endif
