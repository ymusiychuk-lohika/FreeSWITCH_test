...
#define WEBRTC_SPL_MUL_SHIFT(a,b,c) \
    ((int16_t) (((int32_t)(a) * (int32_t)(b))>>c))

#define WEBRTC_SPL_UMUL_SHIFT(a,b,c) \
    ((uint16_t) (((uint32_t)(a) * (uint32_t)(b))>>c))
#endif
...
int WebRtcSpl_GetScalingSquare(const int16_t* in_vector,
...
int32_t WebRtcSpl_Energy(const int16_t* vector, int vector_length, int* scale_factor);
