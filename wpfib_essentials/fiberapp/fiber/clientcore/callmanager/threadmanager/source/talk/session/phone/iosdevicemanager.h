#ifndef TALK_SESSION_PHONE_IOSDEVICEMANAGER_H_
#define TALK_SESSION_PHONE_IOSDEVICEMANAGER_H_
...
class IosDeviceManager : public DeviceManager {
 public:
  IosDeviceManager();
  virtual ~IosDeviceManager();
...
#endif  // TALK_SESSION_PHONE_IOSDEVICEMANAGER_H_
