...
struct pjsip_transaction
{
    ...
    pj_bool_t                  handled_refresh; /**< evsub refresh handling */
};
...
PJ_DECL(const char *) pjsip_role_name(pjsip_role_e role);
 ...
 /*
 * Terminate all transactions for which the user's role is UAC (outbound requests).
 */
PJ_DECL(pj_status_t) pjsip_tsx_terminate_all_uac(pjsip_module *tsx_user);
