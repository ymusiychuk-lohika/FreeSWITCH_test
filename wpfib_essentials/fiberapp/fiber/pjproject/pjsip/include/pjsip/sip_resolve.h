...
/**
 * Get the NS count being used by resolver instance of the SIP resolver engine. 
 *
 * @param res	    The SIP resolver engine.
 *
 * @return	    The NS cound of resolver
 */
PJ_DECL(int) pjsip_resolver_get_ns_count(pjsip_resolver_t *res);

PJ_DECL(void) pjsip_resolver_set_cache(pjsip_resolver_t *res, pj_dns_resolver_cache *res_cache);

PJ_DECL(pj_status_t) pjsip_resolver_flush_cache(pjsip_resolver_t *res);

PJ_DECL(pj_status_t) pjsip_resolver_rotate_cache(pjsip_resolver_t *res);
