...
typedef enum pjsip_transport_type_e
{
    ...
    PJSIP_TRANSPORT_TLS_VIA_PROXY,

    PJSIP_TRANSPORT_TCP_VIA_PROXY,

    PJSIP_TRANSPORT_MULTIPORT,
    ...
    PJSIP_TRANSPORT_MULTIPORT6 = PJSIP_TRANSPORT_MULTIPORT + PJSIP_TRANSPORT_IPV6
