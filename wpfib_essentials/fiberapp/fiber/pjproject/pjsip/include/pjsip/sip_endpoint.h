...
/**
 * Get the number of Name server are being used by the SIP resolver.
 *
 * @param endpt		The SIP endpoint instance.
 *
 * @return		number of name server configured
 */
PJ_DECL(int) pjsip_endpt_get_resolver_ns_count(pjsip_endpoint *endpt);

PJ_DECL(void) pjsip_endpt_set_resolver_cache(pjsip_endpoint *endpt,
                            pj_dns_resolver_cache *cache_tbl);
...
/**
 * Get HTTP proxy instance.
 *
 * @param endpt	    The endpoint.
 *
 * @return	    The proxy host:port value.
 */

PJ_DECL(pj_str_t*) pjsip_endpt_get_http_proxy_config(pjsip_endpoint *endpt);

PJ_DECL(pj_str_t*) pjsip_endpt_get_http_proxyauth_config(pjsip_endpoint *endpt);
...
PJ_DECL(void) pjsip_endpt_set_good_ns_index(pjsip_endpoint *endpt, unsigned index);

PJ_DECL(unsigned) pjsip_endpt_get_good_ns_index(pjsip_endpoint *endpt);
