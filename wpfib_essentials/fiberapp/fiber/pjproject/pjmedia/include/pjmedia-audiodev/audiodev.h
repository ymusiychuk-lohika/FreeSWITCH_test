...
typedef enum pjmedia_aud_dev_cap
{
     ...
     * the latency.
     */
    PJMEDIA_AUD_DEV_CAP_INPUT_LATENCY = (1<<1),
     ...
     * the latency.
     */
    PJMEDIA_AUD_DEV_CAP_OUTPUT_LATENCY = (1<<2),
     ...
     */
    PJMEDIA_AUD_DEV_CAP_INPUT_VOLUME_SETTING = (1<<3),
     ...
     */
    PJMEDIA_AUD_DEV_CAP_OUTPUT_VOLUME_SETTING = (1<<4),
     ...
     */
    PJMEDIA_AUD_DEV_CAP_INPUT_SIGNAL_METER = (1<<5),
     ...
     * enumeration.
     */
    PJMEDIA_AUD_DEV_CAP_OUTPUT_ROUTE = (1<<8),
     ...
     */
    PJMEDIA_AUD_DEV_CAP_EC_TAIL = (1<<10),
     ...
     * PJ_FALSE.
     */
    PJMEDIA_AUD_DEV_CAP_PLC = (1<<13),


    PJMEDIA_AUD_DEV_CAP_OUTPUT_MUTE_SETTING = (1<<14),
    PJMEDIA_AUD_DEV_CAP_MICROPHONE_MUTE = (1<<15) ,

    /*
     *  audio device configuration
     */
    PJMEDIA_AUD_DEV_CAP_CONFIG_OPTIONS= (1<<16),

    PJMEDIA_AUD_DEV_CAP_CALL_MED= (1<<17),
    PJMEDIA_AUD_DEV_CAP_MUTE_AUDIO= (1<<18),
    PJMEDIA_AUD_DEV_CAP_STATS=(1<<19),
    PJMEDIA_AUD_DEV_START_TEST_SOUND=(1<<20),
    PJMEDIA_AUD_DEV_FAST_CHANGE_DEVICES=(1<<21),
    PJMEDIA_AUD_DEV_INTERRUPTED=(1<<22),
    PJMEDIA_AUD_DEV_CAP_HEADSET_MODE =(1<<23),
    PJMEDIA_AUD_DEV_CAP_TYPING_DETECTION=(1<<24),
    PJMEDIA_AUD_DEV_CAP_USE_CUSTOM_AEC=(1<<25),
    PJMEDIA_AUD_DEV_CAP_ECM = (1<<26),
    PJMEDIA_AUD_DEV_CAP_MIC_MONITOR = (1<<27),
    PJMEDIA_AUD_DEV_CAP_SPEAKER_ENDPOINT_VOLUME = (1<<28),
    PJMEDIA_AUD_DEV_CAP_SPEAKER_ENDPOINT_MUTE = (1<<29),
    /**
     * End of capability
     */
    PJMEDIA_AUD_DEV_CAP_MAX = (1<<30),
} pjmedia_aud_dev_cap;
...
typedef struct pjmedia_aud_param
{
    ...
    /** 
     * Boolean to indicate if recording/playback device is internal or external.
     */
    pj_bool_t rec_id_internal;
    pj_bool_t play_id_internal;

    /** 
     * Pointer to Config Parser object. We want to apss it to BJN webrtc audio subsystem
     * Assumption is Config Parser object will be always present when we create audio streams
     */
    void* config_parser;
} pjmedia_aud_param;
 ...
 */
PJ_DECL(pj_status_t)
pjmedia_aud_register_factory(pjmedia_aud_dev_factory_create_func_ptr adf, pjmedia_aud_dev_factory *factory);
...
PJ_DECL(void) pjmedia_aud_stream_rtp_cb(pjmedia_aud_stream *strm, void *usr_data,
                                               void*pkt,  pj_ssize_t len);
PJ_DECL(void) pjmedia_aud_stream_rtcp_cb(pjmedia_aud_stream *strm, void *usr_data,
                                                void*pkt,  pj_ssize_t len);
