...
typedef enum pjmedia_format_id
{
    ...
    /* OPUS from webrtc */
    PJMEDIA_FORMAT_OPUS	    = PJMEDIA_FORMAT_PACK('O', 'P', 'U', 'S'),
    ...
    /**
     * Biplanar format. First plane is Y second is interleaved cbcr
     */
    ...
    PJMEDIA_FORMAT_BSCR     = PJMEDIA_FORMAT_RGB32,
    ...
    PJMEDIA_FORMAT_UNDEF    = PJMEDIA_FORMAT_PACK('U', 'N', 'D', 'F'),
