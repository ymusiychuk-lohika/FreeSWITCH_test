...
/**
 * Min interval to send RTCP FB packets, in msec
 */
#ifndef PJMEDIA_RTCP_FB_MIN_INTERVAL
#   define PJMEDIA_RTCP_FB_MIN_INTERVAL 75      /* msec */
#endif
...
/* IPV4 is 20, IPV6 is 40, used the max as IP header size.*/
#ifndef PJMEDIA_IP_HEADER_SIZE
#   define PJMEDIA_IP_HEADER_SIZE		40
#endif

#ifndef PJMEDIA_UDP_HEADER_SIZE
#   define PJMEDIA_UDP_HEADER_SIZE		8
#endif

#ifndef FEC_HEADER_SIZE
#   define FEC_HEADER_SIZE			    10
#endif

#ifndef FEC_PROTECTION_HEADER_SHORT
#   define FEC_PROTECTION_HEADER_SHORT	4
#endif

#ifndef FEC_PROTECTION_HEADER_LONG
#   define FEC_PROTECTION_HEADER_LONG	8
#endif
...
#   define PJMEDIA_TRANSPORT_SPECIFIC_INFO_MAXSIZE  (128*sizeof(long))
#endif
 ...
 *
 * Current MTU target is 1200 (PJMEDIA_MAX_MTU - 300) to allow packets to go through
 * VPNs without fragmentation, and also to take care of a few lenovo machines that have
 * default MTU of 1200. Note that PJMEDIA_MAX_MTU is used in other calculations so I 
 * opted not to change it directly.
 */
#ifndef PJMEDIA_MAX_VID_PAYLOAD_SIZE
#  define PJMEDIA_MAX_VID_PAYLOAD_SIZE		(PJMEDIA_MAX_MTU - 300)
#endif

/**
 * Macro to get the string representation of the vp8 payload type
 */
#ifndef PJMEDIA_RTP_PT_VP8_STR
#    define PJMEDIA_RTP_PT_VP8_STR                    "102"
#endif

/**
 * Macro to get the string representation of the h264 payload type
 */
#ifndef PJMEDIA_RTP_PT_H264_STR
#    define PJMEDIA_RTP_PT_H264_STR                    "97"
#endif

/**
 * This macro declares the payload type for ulpfec packets
 * that is advertised by PJMEDIA for outgoing SDP. If this macro
 * is set to zero, ulpfec would not be advertised nor
 * supported.
 *
 * If this value is changed to other number, please update the
 * PJMEDIA_RTP_PT_ULPFEC_STR too.
 */
#ifndef PJMEDIA_RTP_PT_ULPFEC
#   define PJMEDIA_RTP_PT_ULPFEC		    122
#endif


/**
 * Macro to get the string representation of the ulpfec
 * payload type.
 */
#ifndef PJMEDIA_RTP_PT_ULPFEC_STR
#   define PJMEDIA_RTP_PT_ULPFEC_STR		    "122"
#endif

#if defined(PJMEDIA_HAS_RED) && (PJMEDIA_HAS_RED != 0)
/**
 * This macro declares the payload type for red packets
 * that is advertised by PJMEDIA for outgoing SDP. If this macro
 * is set to zero, ulpfec would not be advertised nor
 * supported.
 *
 * If this value is changed to other number, please update the
 * PJMEDIA_RTP_PT_RED_STR too.
 */
#ifndef PJMEDIA_RTP_PT_RED
#   define PJMEDIA_RTP_PT_RED		    123
#endif


/**
 * Macro to get the string representation of the red
 * payload type.
 */
#ifndef PJMEDIA_RTP_PT_RED_STR
#   define PJMEDIA_RTP_PT_RED_STR		    "123"
#endif

#endif

/**
 * This macro declares the payload type for rtp retransmission
 * packets that is advertised by PJMEDIA for outgoing SDP. If this macro
 * is set to zero, rtp retransmission would not be advertised nor
 * supported.
 *
 * If this value is changed to other number, please update the
 * PJMEDIA_RTP_PT_RTPX_STR too.
 */
#ifndef PJMEDIA_RTP_PT_RTPX
#   define PJMEDIA_RTP_PT_RTPX		    125
#   define PJMEDIA_RTP_RTPX_BUFF_TIME       3000
#endif


/**
 * Macro to get the string representation of the retransmission 
 * payload type.
 */
#ifndef PJMEDIA_RTP_PT_RTPX_STR
#   define PJMEDIA_RTP_PT_RTPX_STR		    "125"
#   define PJMEDIA_RTP_RTPX_BUFF_TIME_STR           "3000"
#endif
