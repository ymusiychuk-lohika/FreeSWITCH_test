...
/* An enum to indicate whether it's an RTP or one recovered by a error resiliency algorithm */
typedef enum pjmedia_rtp_pkt_type
{
    PJMEDIA_NORMAL_RTP,
    PJMEDIA_RECOVERED_BY_FEC,
    PJMEDIA_RECOVERED_BY_RTX,
    PJMEDIA_FEC_WITH_UNIQUE_SSRC,

} pjmedia_rtp_pkt_type;
