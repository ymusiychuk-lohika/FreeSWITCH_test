...
//#define SOUND_PORT_AUDIO_RECORDING 1
...
PJ_DECL(pj_status_t) pjmedia_snd_port_start_audiologging(pjmedia_snd_port *snd_port);
PJ_DECL(pj_status_t) pjmedia_snd_port_stop_audiologging(pjmedia_snd_port *snd_port);

PJ_DECL(pj_status_t) pjmedia_snd_port_set_render_scaling(pjmedia_snd_port *snd_port, pj_int16_t scalar, pj_uint8_t radix);

PJ_DECL(pj_status_t) pjmedia_snd_port_set_speaker_mute(pjmedia_snd_port *snd_port,
						  pj_bool_t val);


PJ_DECL(pj_bool_t) pjmedia_snd_port_is_dev_interrupted(pjmedia_snd_port *snd_port);
