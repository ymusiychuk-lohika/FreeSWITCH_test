...
/**
 * Unregister the callbacks of the video port's underlying video stream.
 *
 * @param vid_port	The video port.
 * @param cb            Pointer to structure containing video stream
 *                      callbacks.
 */
PJ_DECL(void) pjmedia_vid_port_unreg_cb(pjmedia_vid_port *vid_port,
...
/**
 * Start the clock thread of video port to resume processing of frames.
 *
 * @param vid_port	The video port.
 *
 * @return		PJ_SUCCESS on success or the appropriate error code.
 */
PJ_DECL(pj_status_t) pjmedia_vid_port_clock_start(pjmedia_vid_port *vid_port);
...
/**
 * Stop the clock thread of video port to stop processing of frames.
 *
 * @param vid_port	The video port.
 *
 * @return		PJ_SUCCESS on success or the appropriate error code.
 */
PJ_DECL(pj_status_t) pjmedia_vid_port_clock_stop(pjmedia_vid_port *vid_port);
