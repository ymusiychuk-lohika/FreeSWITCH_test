...
typedef struct pjmedia_vid_dev_switch_param
{
    ...
    /* provide extra info  eg: send view/frame pointer*/
    void* data;
...
typedef enum pjmedia_vid_dev_cap
{
    ...
    /*
     * Support for screen share from view 
     */
     PJMEDIA_VID_DEV_CAP_SET_VIEW = 1024,

    /*
     * Support for reference counting
     */
     PJMEDIA_VID_DEV_CAP_REFERENCE_COUNT = 2048,
