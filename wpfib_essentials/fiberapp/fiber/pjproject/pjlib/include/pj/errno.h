 ...
 * ICE RTP timeout
 */
#define PJ_RTP_COMP_TIMEOUT	    (PJ_ERRNO_START_STATUS + 24)/* 70024 */

/**
 * @hideinitializer
 * ICE RTCP timeout
 */
#define PJ_RTCP_COMP_TIMEOUT	    (PJ_ERRNO_START_STATUS + 25)/* 70025 */

/**
 * @hideinitializer
 * ICE RTP Recovered
 */
#define PJ_RTP_COMP_RECOVERED	    (PJ_ERRNO_START_STATUS + 26)/* 70026 */

/**
 * @hideinitializer
 * ICE RTCP Recovered
 */
#define PJ_RTCP_COMP_RECOVERED	    (PJ_ERRNO_START_STATUS + 27)/* 70027 */

/**
 * @hideinitializer
 * Reice ICE stream
 */
#define PJ_REICE_STREAM	    (PJ_ERRNO_START_STATUS + 28)/* 70028 */
