...
typedef enum pj_ssl_cipher {
    ...
    PJ_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA       = 0x0000C014,
    PJ_TLS_RSA_WITH_CAMELLIA_256_CBC_SHA        = 0x00000084,
    PJ_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA       = 0x0000C013,
    PJ_TLS_RSA_WITH_SEED_CBC_SHA                = 0x00000096,
    PJ_TLS_RSA_WITH_CAMELLIA_128_CBC_SHA        = 0x00000041,
    PJ_TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA      = 0x0000C012,
    PJ_TLS_RSA_WITH_AES_128_GCM_SHA256          = 0x0000009C,
    PJ_TLS_RSA_WITH_AES_256_GCM_SHA384          = 0x0000009D,
...
PJ_DECL(pj_status_t) pj_ssl_sock_start_connect(pj_ssl_sock_t *ssock,
					       ...
					       int addr_len);
PJ_DECL(pj_status_t) pj_ssl_sock_start_connect_via_proxy(pj_ssl_sock_t *ssock,
					                 pj_pool_t *pool,
					                 const pj_sockaddr_t *localaddr,
					                 const pj_sockaddr_t *remaddr,
					                 int addr_len,
...
PJ_DECL(pj_status_t) pj_ssl_sock_start_connect_continue(pj_ssl_sock_t *ssock,
					                pj_pool_t *pool,
					                const pj_sockaddr_t *localaddr,
					                const pj_sockaddr_t *remaddr,
					                int addr_len, pj_bool_t is_proxy);
...
PJ_DECL(pj_status_t) pj_ssl_sock_setsockopt(pj_ssl_sock_t *ssock,
					pj_uint16_t level,
					pj_uint16_t optname,
					const void *optval,
					int optlen);

PJ_DECL(void) pj_dump_ssl_info(pj_ssl_sock_t *ssock);

/* Initialize OpenSSL */
PJ_DECL(pj_status_t) init_openssl(void);
/* Shutdown OpenSSL */
PJ_DECL(void) shutdown_openssl(void);
