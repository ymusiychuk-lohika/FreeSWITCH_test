 ...
 * @param marker    Marker.
 */
PJ_DECL(void) pj_log(int line, const char *sender, int level, 
 ...
 */
#if PJ_LOG_MAX_LEVEL >= 1
    #define pj_log_wrapper_1(src, format, ...)	pj_log_1 (__LINE__, src, format, ## __VA_ARGS__)
    /** Internal function. */
    PJ_DECL(void) pj_log_1(int line, const char *src, const char *format, ...);
#else
    #define pj_log_wrapper_1(src, format, ...)
#endif
 ...
 */
    ...
    #define pj_log_wrapper_2(src, format, ...)	pj_log_2 (__LINE__, src, format, ## __VA_ARGS__)
    /** Internal function. */
    PJ_DECL(void) pj_log_2(int line, const char *src, const char *format, ...);
#else
    #define pj_log_wrapper_2(src, format, ...)
#endif
 ...
 */
    ...
    #define pj_log_wrapper_3(src, format, ...)	pj_log_3 (__LINE__, src, format, ## __VA_ARGS__)
    /** Internal function. */
    PJ_DECL(void) pj_log_3(int line, const char *src, const char *format, ...);
#else
    #define pj_log_wrapper_3(src, format, ...)
#endif
 ...
 */
    ...
    #define pj_log_wrapper_4(src, format, ...)	pj_log_4 (__LINE__, src, format, ## __VA_ARGS__)
    /** Internal function. */
    PJ_DECL(void) pj_log_4(int line, const char *src, const char *format, ...);
#else
    #define pj_log_wrapper_4(src, format, ...)
#endif
 ...
 */
    ...
    #define pj_log_wrapper_5(src, format, ...)	pj_log_5 (__LINE__, src, format, ## __VA_ARGS__)
    /** Internal function. */
    PJ_DECL(void) pj_log_5(int line, const char *src, const char *format, ...);
#else
    #define pj_log_wrapper_5(src, format, ...)
#endif
 ...
 */
    ...
    #define pj_log_wrapper_6(src, format, ...)	pj_log_6 (__LINE__, src, format, ## __VA_ARGS__)
    /** Internal function. */
    PJ_DECL(void) pj_log_6(int line, const char *src, const char *format, ...);
#else
    #define pj_log_wrapper_6(src, format, ...)
#endif
