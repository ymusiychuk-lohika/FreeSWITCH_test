...
typedef struct pj_sockpair_t pj_sockpair_t;

PJ_DECL(pj_status_t) pj_socketpair_create(pj_ioqueue_t *ioqueue,
                                 pj_pool_t *pool,
                                 pj_sockpair_t **p_socketpair);

PJ_DECL(pj_status_t) pj_socketpair_close(pj_sockpair_t *socketpair);

PJ_DECL(pj_status_t) pj_socketpair_write(pj_sockpair_t *socketpair);

PJ_DECL(pj_ioqueue_key_t *) pj_socketpair_get_read_key(pj_sockpair_t *socketpair);
