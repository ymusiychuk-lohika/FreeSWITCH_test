...
/**
 * Get the total number of Name servers.
 *
 * @param resolver  The resolver instance.
 *
 * @return	    number of Name server configured
 */
PJ_DECL(int) pj_dns_resolver_get_ns_count(pj_dns_resolver *resolver);
...
/**
 * Api to increment cached resnponse index to do rotation on the ip addresses
 * @param resolver  The resolver instance.
 */
PJ_DEF(void) pj_dns_resolver_inc_cache_index(pj_dns_resolver *resolver);
