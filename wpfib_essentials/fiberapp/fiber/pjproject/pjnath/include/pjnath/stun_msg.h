...
typedef enum pj_stun_attr_type
{
    ...
    PJ_STUN_ATTR_START_CUSTOM_ATTR= 0xA000,

    PJ_STUN_ATTR_BANDWIDTH_BURST    = 0xA001,/**Burst factor to be multipled by to get proper buffer size*/
    PJ_STUN_ATTR_X_BANDWIDTH        = 0xA002,/**< TURN BANDWIDTH */
    PJ_STUN_ATTR_X_CALL_GUID        = 0xA003,/**< call guid for fiber clients */
    PJ_STUN_ATTR_X_TURN_NODEID      = 0xA004,/**< Turn server denim node id */
    PJ_STUN_ATTR_X_MEDIA_TYPE       = 0xA005,/**< Media type */
    PJ_STUN_ATTR_X_BUFFER_SIZE      = 0xA006,/**< socket buffer size to be used */

    PJ_STUN_ATTR_END_CUSTOM_ATTR,
